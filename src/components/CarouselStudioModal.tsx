...
import { STARK_CURATED_BACKGROUNDS, ENGLISH_CAROUSEL_PRESETS } from "./carousel/carousel-data";
                ...
                <div className="bg-[#1D2333] p-4 rounded-lg border border-[#2C354B] space-y-3.5">
                  ...
                  <div className="pt-2 border-t border-[#2C354B]/60 space-y-2">
                    ...
                    <p className="text-[9px] text-slate-500 font-mono">
                      💡 Wskazówka: Wpisz dowolne słowa po przecinku lub otocz słowa gwiazdkami
                      bezpośrednio w tekście, np.{" "}
