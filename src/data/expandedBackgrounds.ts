...
export const EXPANDED_BACKGROUND_LIBRARY: BackgroundScene[] = [
  // 1. ANTYCZNA ARCHITEKTURA I MONUMENTY (15)
  {
    ...
    theme: "obsidian_void",
    description: "Mroczne marmurowe popiersie Seneki, zimne boczne światło, czarna bezkresna pustka",
    rationale: "Podkreśla bezkompromisowy autorytet myśli i stoickie opanowanie wobec chaosu.",
    bingPrompt: "Minimalist dark marble statue bust of Seneca philosopher, dramatic directional side rim light, pitch black void background, cinematic chiaroscuro, 8k vertical 9:16",
    previewColor: "#0A0A0C",
  },
  {
    id: "arch_02",
    ...
    bingPrompt: "Monumental ancient Corinthian marble pillars shrouded in dark nocturnal mist, dramatic low-key rim lighting, matte charcoal textures, cinematic editorial vertical 9:16",
    previewColor: "#101317",
  },
  {
    id: "arch_03",
    ...
    category: "Architektura & Rzeźba",
    theme: "pantheon_mist",
    description: "Ciemne, kamienne wejście do rzymskiego panteonu z subtelną bursztynowo-złotą poświatą",
    rationale: "Majestat starożytnego porządku i święta powaga dyscypliny.",
    bingPrompt: "Dark monumental Roman Pantheon portico at midnight, subtle deep amber and gold atmospheric backlight, monolithic stone shadows, editorial 35mm photography 9:16",
    previewColor: "#14110A",
  },
  {
    id: "arch_04",
    ...
    bingPrompt: "Dramatic Winged Victory of Samothrace marble statue in deep black shadows, cold silver rim light, high contrast chiaroscuro, 8k vertical 9:16",
    previewColor: "#0E1114",
  },
  {
    id: "arch_05",
    ...
    bingPrompt: "Dark weathered bronze sculpture bust of Epictetus, raw textured surface, single cold spotlight in pure black abyss, editorial composition 9:16",
    previewColor: "#080808",
  },
  {
    id: "arch_06",
    ...
    bingPrompt: "Ancient weathered granite stone stairs ascending into pure pitch-black darkness, subtle raking side light highlighting texture, minimalist stoic mood 9:16",
    previewColor: "#121214",
  },
  {
    id: "arch_07",
    ...
    bingPrompt: "Massive dark stone triumphal arch in nocturnal cold rain, wet dark reflections on ancient cobblestones, cinematic moody atmosphere 9:16",
    previewColor: "#0C1014",
  },
  {
    id: "arch_08",
    ...
    bingPrompt: "Brutalist ancient basalt stone crypt, extreme minimalist geometry, razor-thin sliver of cold ambient illumination, silent atmosphere 9:16",
    previewColor: "#050608",
  },
  {
    id: "arch_09",
    ...
    bingPrompt: "Empty ancient stone amphitheater under cold midnight sky, moonlight casting sharp geometric shadows, stoic solitude, editorial 9:16",
    previewColor: "#0D0E12",
  },
  {
    id: "arch_10",
    ...
    bingPrompt: "Dark basalt sacrificial altar with deep crimson dying embers in pure black void, moody chiaroscuro lighting, stoic solemnity, vertical 9:16",
    previewColor: "#160608",
  },
  {
    id: "arch_11",
    ...
    category: "Architektura & Rzeźba",
    theme: "pantheon_mist",
    description: "Zarys ruin przed wschodem słońca, pierwsze zimne złote promienie na szczytach kapiteli",
    rationale: "Poranny rytuał bezkompromisowej gotowości do walki z własną słabością.",
    bingPrompt: "Ruins of Roman Forum colonnade in blue hour before dawn, subtle muted golden rim light on top of columns, peaceful stoic majesty 9:16",
    previewColor: "#12100A",
  },
  {
    id: "arch_12",
    ...
    bingPrompt: "Granite sculpted head of Olympian sovereign deity emerging from obsidian shadow, sharp dramatic side lighting, austere stoic expression 9:16",
    previewColor: "#070709",
  },
  {
    id: "arch_13",
    ...
    bingPrompt: "Minimalist black marble portal gateway, sharp orthogonal lines, subtle volumetric haze, cinematic dramatic depth, vertical 9:16",
    previewColor: "#0B0D10",
  },
  {
    id: "arch_14",
    ...
    bingPrompt: "Classical marble bust of Cicero, high contrast chiaroscuro, cold silver directional spotlight, pure dark background, 8k 9:16",
    previewColor: "#0D1116",
  },
  {
    id: "arch_15",
    ...
    bingPrompt: "Dark Roman impluvium still water reflecting moonlight, surrounded by stone peristyle in shadows, emerald dark gradient, serene 9:16",
    previewColor: "#05120D",
  },
  ...
  // 2. SUROWA NATURA, KLIFY I ŻYWIOŁY (15)
  {
    ...
    bingPrompt: "Massive black jagged granite cliff enduring powerful crashing ocean waves at midnight, silver seafoam mist, dramatic stoic mood 9:16",
    previewColor: "#0A1014",
  },
  {
    id: "nat_02",
    ...
    bingPrompt: "Solitary gnarled pine tree clinging to high dark rocky summit, surrounded by dense moody fog, deep emerald tone, vertical 9:16",
    previewColor: "#06130E",
  },
  {
    id: "nat_03",
    ...
    bingPrompt: "Endless black volcanic sand dunes at twilight, sharp wind-sculpted ridges, pure matte black shadows, minimal stoic landscape 9:16",
    previewColor: "#060607",
  },
  {
    id: "nat_04",
    ...
    bingPrompt: "Massive dark glacier wall with black volcanic ash strata, extreme cold atmospheric mist, high contrast cinematic photography 9:16",
    previewColor: "#0A1016",
  },
  {
    id: "nat_05",
    ...
    bingPrompt: "Glassy pitch-black alpine lake mirroring dark mountain silhouettes, solitary motionless water, meditative quietness, 9:16 vertical",
    previewColor: "#040507",
  },
  {
    id: "nat_06",
    ...
    bingPrompt: "Deep narrow basalt canyon walls rising vertically, cold diffuse skylight from above, mysterious brooding shadows, vertical 9:16",
    previewColor: "#0E1013",
  },
  {
    id: "nat_07",
    ...
    bingPrompt: "Solar eclipse totality over dark barren plains, thin deep crimson coronal ring blazing in black sky, ominous stoic awe 9:16",
    previewColor: "#170507",
  },
  {
    id: "nat_08",
    ...
    bingPrompt: "Dark powerful waterfall plunging into deep misty gorge, cold emerald twilight tones, long exposure silk water, editorial 9:16",
    previewColor: "#071410",
  },
  {
    id: "nat_09",
    ...
    bingPrompt: "Frozen dark barren tundra with crisp white frost on black earth, freezing twilight horizon, raw solitude, 35mm lens 9:16",
    previewColor: "#0B0F14",
  },
  {
    id: "nat_10",
    ...
    bingPrompt: "Single razor-sharp lightning strike illuminating dark storm clouds, high contrast pitch black silhouette, cinematic photography 9:16",
    previewColor: "#06070A",
  },
  {
    id: "nat_11",
    ...
    bingPrompt: "Razor-sharp dark mountain ridge emerging above a sea of dark dramatic clouds, moody twilight gradient, stoic atmosphere 9:16",
    previewColor: "#111217",
  },
  {
    id: "nat_12",
    ...
    bingPrompt: "Deep dark pine forest after heavy nocturnal snowfall, stark contrast of black tree trunks and white snow, serene silence 9:16",
    previewColor: "#0E1116",
  },
  {
    id: "nat_13",
    ...
    bingPrompt: "Raindrops streaking across black tinted glass window at night, cold distant ambient blur, moody introspective atmosphere 9:16",
    previewColor: "#07080B",
  },
  {
    id: "nat_14",
    ...
    bingPrompt: "Interior of dark cavern with sharp ice stalactites, directional cold moonlight piercing the entrance, stoic clarity 9:16",
    previewColor: "#090D12",
  },
  {
    id: "nat_15",
    ...
    bingPrompt: "Dark textured asteroid floating in pure black cosmic void, subtle side starlight rim illumination, minimalist cosmic stoicism 9:16",
    previewColor: "#040405",
  },
  ...
  // 3. MINIMALISTYCZNA GEOMETRIA, ŚWIATŁOCIEŃ & VOID (15)
  {
    ...
    bingPrompt: "Ultra-minimalist pitch black room, single razor-thin beam of cold white light cutting through dense atmospheric haze, 9:16 vertical",
    previewColor: "#050608",
  },
  {
    id: "void_02",
    ...
    bingPrompt: "Brutalist dark concrete hallway with sharp geometric angled shadows, architectural chiaroscuro, raw industrial texture 9:16",
    previewColor: "#111316",
  },
  {
    id: "void_03",
    ...
    bingPrompt: "Matte dark carbon fiber weave surface, precision texture, extreme close-up, subtle diagonal shadow line, high tech minimalism 9:16",
    previewColor: "#0F1115",
  },
  {
    id: "void_04",
    ...
    bingPrompt: "Pure black composition with thin glowing crimson red horizon line at the lower third, mysterious dark ambient vignette 9:16",
    previewColor: "#150406",
  },
  {
    id: "void_05",
    ...
    bingPrompt: "Minimal dark obsidian cube outlined with faint muted gold metallic edge, floating in deep black void, elegant editorial 9:16",
    previewColor: "#13100A",
  },
  {
    id: "void_06",
    ...
    bingPrompt: "Brushed dark titanium metal panel diagonally split by hard edge shadow, subtle metallic grain, stark industrial aesthetic 9:16",
    previewColor: "#101216",
  },
  {
    id: "void_07",
    ...
    bingPrompt: "Minimalist black ziggurat stepped pyramid, raking light showing stone steps, void background, timeless ancient geometry 9:16",
    previewColor: "#08090C",
  },
  {
    id: "void_08",
    ...
    bingPrompt: "Massive dark stone monolith with narrow vertical fissure leaking cold white luminescence, dramatic volumetric haze 9:16",
    previewColor: "#0B0E12",
  },
  {
    id: "void_09",
    ...
    bingPrompt: "Zen rock garden raked black gravel concentric circles around dark stone, moonlight chiaroscuro, perfect meditative symmetry 9:16",
    previewColor: "#070709",
  },
  {
    id: "void_10",
    ...
    bingPrompt: "Delicate swirl of deep emerald and charcoal smoke curling in total black vacuum, frozen in motion, high-speed photography 9:16",
    previewColor: "#05110B",
  },
  {
    id: "void_11",
    ...
    bingPrompt: "Dark wireframe steel grid vanishing into atmospheric fog, architectural perspective, brutalist structural elegance 9:16",
    previewColor: "#0D0F13",
  },
  {
    id: "void_12",
    ...
    bingPrompt: "Pristine black portal opening leading into darker void, sharp rectangular edges, minimal editorial aesthetic 9:16",
    previewColor: "#050506",
  },
  {
    id: "void_13",
    ...
    bingPrompt: "Single perfect water droplet suspended motionless in black air, cold rim illumination, macro frozen moment, editorial 9:16",
    previewColor: "#0A0D11",
  },
  {
    id: "void_14",
    ...
    bingPrompt: "Minimalist matte black sundial dial without hands, subtle engraved hash marks, cold angled raking light, stoic memento mori 9:16",
    previewColor: "#0C0E12",
  },
  {
    id: "void_15",
    ...
    bingPrompt: "Dark glass hourglass in deep shadows with black sand falling grain by grain, subtle crimson backlight edge, moody 9:16",
    previewColor: "#130507",
  },
  ...
  // 4. MROCZNE MIASTO, ULICA O 4:30 RANO & MNISI TRYB (15)
  {
    ...
    bingPrompt: "Moody empty city street at 4:30 AM before dawn, wet reflective black asphalt, lone solitary figure walking away in distance 9:16",
    previewColor: "#08090C",
  },
  {
    id: "city_02",
    ...
    bingPrompt: "Monolithic dark skyscraper at 3 AM with only a single solitary lit window, deep urban chiaroscuro, cinematic stoic focus 9:16",
    previewColor: "#0D1015",
  },
  {
    id: "city_03",
    ...
    bingPrompt: "Empty suspension bridge in heavy nocturnal fog, dark cold steel cables disappearing into mist, quiet solitude 9:16",
    previewColor: "#0A0E13",
  },
  {
    id: "city_04",
    ...
    bingPrompt: "Ultra-dark underground gym, heavy cast iron weights, raw concrete walls, cold single overhead spotlight, moody atmospheric dust 9:16",
    previewColor: "#101216",
  },
  {
    id: "city_05",
    ...
    bingPrompt: "Empty nocturnal train platform, shiny wet railway tracks vanishing into pure black darkness, cold moody mist 9:16",
    previewColor: "#06080B",
  },
  {
    id: "city_06",
    ...
    bingPrompt: "Hooded runner silhouette moving through dark foggy industrial shipping docks at dawn, cold ambient rim light, cinematic grit 9:16",
    previewColor: "#0E1114",
  },
  {
    id: "city_07",
    ...
    bingPrompt: "Minimalist dark wooden desk in pure black room, single direct warm-cool spotlight on open leather journal, quiet monk mode 9:16",
    previewColor: "#070809",
  },
  {
    id: "city_08",
    ...
    bingPrompt: "Empty modern concrete tunnel at night, rhythmic overhead ceiling lights leading to infinite vanishing point, cinematic depth 9:16",
    previewColor: "#111419",
  },
  {
    id: "city_09",
    ...
    bingPrompt: "Rooftop edge of skyscraper looking down at thick sea of nocturnal fog blanketing city below, cold moonlight, solitary vantage point 9:16",
    previewColor: "#0C1015",
  },
  {
    id: "city_10",
    ...
    bingPrompt: "Black iron fire escape zig-zagging down dark wet brick building wall, moody urban chiaroscuro, cinematic 9:16",
    previewColor: "#121113",
  },
  {
    id: "city_11",
    ...
    bingPrompt: "Heavy dark leather boxing punch bag hanging in shadowy warehouse gym, subtle crimson rim lighting, raw gritty stoic texture 9:16",
    previewColor: "#150608",
  },
  {
    id: "city_12",
    ...
    bingPrompt: "Dark monolithic glass skyscraper facade reflecting stormy midnight clouds, sharp geometric reflections, architectural minimalism 9:16",
    previewColor: "#0A0D12",
  },
  {
    id: "city_13",
    ...
    bingPrompt: "Nocturnal black asphalt highway, lone vehicle red taillights fading into pitch black forest mist, moody introspective journey 9:16",
    previewColor: "#060709",
  },
  {
    id: "city_14",
    ...
    bingPrompt: "Ancient dark wooden library towering shelves, deep chiaroscuro shadows, single shaft of soft golden light on leather books 9:16",
    previewColor: "#120F0A",
  },
  {
    id: "city_15",
    ...
    bingPrompt: "Massive industrial harbor crane silhouette against dark charcoal dawn sky, brutalist steel geometry, stoic resilience 9:16",
    previewColor: "#0F1116",
  },
];
...
export function getRandomBackgroundScene(filterTheme?: ReelVisualTheme): BackgroundScene {
  ...
  if (pool.length === 0) {
    return EXPANDED_BACKGROUND_LIBRARY[Math.floor(Math.random() * EXPANDED_BACKGROUND_LIBRARY.length)];
  }
