...
#discipline #selfgrowth #solitude #grind #relentless #stoicmindset`,
      notes:
        "Dark atmospheric walking clip, subtle zoom-in, loop connecting the last word to the first.",
    },
    {
...
#stoicism #disciplinerules #habits #successblueprint #mentalstrength`,
      notes:
        "Design using pure black slides with 60% black blur. Cover must use bold white typography.",
    },
    {
...
#solitude #darkaesthetic #monkmode #focus #growthmindset`,
      notes: "Use minimalist dark visuals (geometric pillars, dark basalt, foggy skyscrapers).",
    },
    {
