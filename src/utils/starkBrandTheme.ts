import { VisualTheme, LogoSourceType, LogoPlacement, LogoGlowChoice, TopHeaderMode } from '../types';
...
export function normalizeLogoPlacement(placement: string): LogoPlacement {
  if (placement === 'bottom' || placement === 'bottom_under' || placement === 'footer' || placement === 'bottom_inline' || placement === 'bottom_above') {
    return 'bottom_under';
  }
  if (placement === 'top' || placement === 'top_left' || placement === 'top_right' || placement === 'top_center') {
    return 'top_left';
  }
  if (placement === 'center_watermark' || placement === 'background_watermark' || placement === 'watermark') {
