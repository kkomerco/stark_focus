...
const InspirationStudio1to1 = lazy(() =>
  import("./components/InspirationStudio1to1").then((m) => ({
    default: m.InspirationStudio1to1,
  })),
);
const VideoStudioModal = lazy(() =>
  import("./components/VideoStudioModal").then((m) => ({
    default: m.VideoStudioModal,
  })),
);
const AiRadarTab = lazy(() =>
  import("./components/tabs/AiRadarTab").then((m) => ({
    default: m.AiRadarTab,
  })),
);
const DailyPackModal = lazy(() =>
  import("./components/DailyPackModal").then((m) => ({
    default: m.DailyPackModal,
  })),
);
const IdeaStreamModal = lazy(() =>
  import("./components/IdeaStreamModal").then((m) => ({
    default: m.IdeaStreamModal,
  })),
);
const DeconstructViralModal = lazy(() =>
  import("./components/DeconstructViralModal").then((m) => ({
    default: m.DeconstructViralModal,
  })),
);
const AbModal = lazy(() => import("./components/AbModal").then((m) => ({ default: m.AbModal })));
const AutopilotModal = lazy(() =>
  import("./components/AutopilotModal").then((m) => ({
    default: m.AutopilotModal,
  })),
);
...
export default function StarkFocusApp() {
  ...
  const [reelPreset, setReelPreset] = useState<{
    hook?: string;
    bgUrl?: string;
  }>({});
